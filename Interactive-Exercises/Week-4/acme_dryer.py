...
# The main function performes the program's main logic
...
def startup_message():
    print('This program tell you how to')
    print('dissasemble an ACME laundry dryer.')
...
def step2():
    ...
    print('from the bavk of the dryer.')
    print()
